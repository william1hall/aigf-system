...
| 功能 | 说明 | 工期 |
|------|------|------|
| 长期记忆 | 记住你说过的事，两周后还能自然提起 | 2-3天 |
| 智能关怀 | 天气变化提醒、考试/面试前加油 | 1-2天 |
| 吵架和好 | 冷战/道歉/和好，情绪驱动的关系波动 | 3-4天 |
| 她的社交圈 | 室友、闺蜜NPC，"今天和小雨吃了火锅" | 2-3天 |
| 亲密度系统 | 每日互动积分，解锁新称呼/新行为 | 2-3天 |
| 惊喜系统 | 纪念日倒计时，自动准备小惊喜 | 1-2天 |
...
| 功能 | 说明 | 工期 |
|------|------|------|
| Live2D 虚拟形象 | 情绪驱动表情变化，桌面/手机小组件 | 1-2周 |
| 语音进化 | 实时语音对话、晚安故事、唱歌 | 1周 |
| 朋友圈/动态 | 定时发图文动态，你可以点赞评论 | 2-3天 |
| 短视频/GIF | 3-5秒动态自拍（眨眼/挥手/转头）| 取决于API |
| 消息节奏感 | 打字中...延迟，长消息分条发送 | 需要OpenClaw hook |
| 共同爱好 | 一起追剧/看书，分享日常小发现 | 2-3天 |
...
| 功能 | 说明 | 工期 |
|------|------|------|
| 人生成长线 | 论文进度/毕业/职业发展 | 1-2周 |
| 虚拟房间 | 她的宿舍3D场景，可以"去她那里" | 2-4周 |
| 视频通话 | 实时数字人渲染，面对面聊天 | 取决于技术 |
| 多角色生态 | 闺蜜/室友 agent，群聊互动 | 1-2周 |
| 全平台覆盖 | 微信/抖音/小红书 | 按平台计 |
| 专属App | 独立聊天界面，Live2D+语音+动态 | 4-8周 |
